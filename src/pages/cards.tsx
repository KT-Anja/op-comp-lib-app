	...
	return (
		<>
			<div className="row mb-4 cards row-cols-4 align-start">
				<div className="col">
					<div className="card">
						<img src="/src/assets/naturfotografie.jpg" className="card-img-top" alt="..." />
						{/* <Img /> */}
				...
				<div className="col">
					<div className="card bg-white">
						<img
							src="/src/assets/naturfotografie-naturfotograf-tipps-2.jpg"
				...
				<div className="col">
					<div className="card">
						<div className="card-body">
							<h3 className="card-title">Very very very very very very very long card title</h3>
							<p className="card-text">
								Some quick example text to build on the card title and make up the bulk of the
								card's content. Some quick example text to build on the card title and make up the
								bulk of the card's content.
